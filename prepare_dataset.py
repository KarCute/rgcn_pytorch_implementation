...
if DATASET == 'aifb' or DATASET == 'am' or DATASET == 'bgs' or DATASET == 'mutag':
    ...
    A, X, y, labeled_nodes_idx, train_idx, test_idx, val_idx, rel_dict, train_names, test_names, val_names = load_data_cora('./data/'+ DATASET + '/',
    DATASET)
else:
    A, X, y, labeled_nodes_idx, train_idx, test_idx, val_idx, rel_dict, train_names, test_names, val_names = load_data_fb('./data/'+ DATASET + '/',
    DATASET)
